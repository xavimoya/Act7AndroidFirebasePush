...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tokenbutton = (Button)findViewById(R.id.tokenbutton);
        tokenbutton.setOnClickListener(this);

        Button topicbutton = (Button)findViewById(R.id.registertopic);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.registertopic:
                //Subscribe topic
                FirebaseMessaging.getInstance().subscribeToTopic("news");

                //Log and toast

                String msg2 = "Subscribed to topic 'news'";
                Log.d(TAG,msg2);
